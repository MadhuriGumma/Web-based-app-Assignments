...
function Game(tileNames) {
    ...
    this.flipTile = function(tile) {
        ...
        if (!this.firstPick || this.secondPick) {
            ...
            if (this.secondPick.title != this.firstPick.title) {
                ...
                if (this.thirdPick.title != this.secondPick.title) {

                    this.firstPick.flip();
                    this.secondPick.flip();
                    this.thirdPick.flip();
                    this.firstPick = this.secondPick = this.thirdPick = undefined;
                }
                else{
                    this.thirdPick = tile;
                    this.message = Game.MESSAGE_ONE_MORE;
                    if(this.thirdPick.title != this.fourthPick.title){
                        this.firstPick.flip();
                        this.secondPick.flip();
                        this.thirdPick.flip();
